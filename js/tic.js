...
function compare() {
    ...
    if(ans=="X"){
        ...
        for(var i=0;i<points.length;i++){
            document.getElementById(points[i]).innerHTML="<img src='images/heart.png' class='animated bounceIn infinite' width=80px heigth=80px style='margin-right:5px;'>";
            document.getElementById("music").innerHTML="<embed src='winning.mp3' autostart='true' loop='true' width='2' height='0'></embed>"
